...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcomment{# Use cars data, loaded in R by default Create}
\hlcomment{# bar plot}
\hlfunctioncall{plot}(MortalityGDP$region)
\end{alltt}
\end{kframe}
...
\frame{
  \frametitle{Scatterplot-like}
  You can use {\bf{contingency tables}} and {\bf{mosaic plots}} like scatter plots when you have categorical data.
}
