...
{\ttfamily\noindent\bfseries\textcolor{errorcolor}{\#\# Error: object 'InfantMortality' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\textcolor{errorcolor}{\#\# Error: object 'InfantNoMiss' not found}}\end{kframe}
\end{knitrout}
...
{\ttfamily\noindent\bfseries\textcolor{errorcolor}{\\Error in median(InfantNoMiss\$InfantMortality) : \\  object 'InfantNoMiss' not found}}
    \item {\bf{Mean:}} 

{\ttfamily\noindent\bfseries\textcolor{errorcolor}{\\Error in mean(InfantNoMiss\$InfantMortality) : \\  object 'InfantNoMiss' not found}}
  \end{itemize}
\end{frame}
...
{\ttfamily\noindent\bfseries\textcolor{errorcolor}{\#\# Error: object 'InfantNoMiss' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\textcolor{errorcolor}{\#\# Error: object 'OrderMort' not found}}\begin{alltt}
...
{\ttfamily\noindent\bfseries\textcolor{errorcolor}{\#\# Error: object 'OrderMort' not found}}\end{kframe}
\end{knitrout}
...
\frame{
  ...
  \[
    \mathrm{Sum\:of\:Squares} = \sum(x - \bar{x})
  \]
...
\frame{
  ...
  \[
    s^{2} = \frac {\mathrm{Sum\:of\:Squares}}{\mathrm{Degrees\:of\:Freedom}} = \frac{\sum(x - \bar{x})}{n - 1}
  \]
...
{\centering \includegraphics[width=\maxwidth]{figure/SDNormal} 
...
{\ttfamily\noindent\bfseries\textcolor{errorcolor}{\#\# Error: object 'InfantNoMiss' not found}}
