...
\end{knitrout}
  ...
  {\large{\texttt{Time} in our original sample with 100 observations had a sampleing mean of 95.3 and a standard error of 1.6.
\end{frame}
...
\frame{
  \frametitle{Um\ldots}
  {\Large{Um \ldots a sampleing mean of 95.3 and a standard error of 1.6? \\[1cm]
...
\frame{
  ...
  \begin{table}
    ...
    \hline\hline
    \texttt{time} & 92.2 & 95.3 & 98.3 & 94.5 \\
      \texttt{age} & 33.7 & 35.8 & 37.8 & 35.5 \\
      \hline
