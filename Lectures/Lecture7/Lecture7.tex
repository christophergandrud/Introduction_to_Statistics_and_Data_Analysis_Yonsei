...
\end{knitrout}
  ...
  {\large{So, \texttt{time} in our original sample with 100 observations had a sampleing mean of 95.8 and a standard error of 1.7.
\end{frame}
...
\frame{
  \frametitle{Um\ldots}
  {\Large{Um \ldots a sampleing mean of 95.8 and a standard error of 1.7? \\[1cm]
...
\frame{
  ...
  \begin{table}
    ...
    \hline\hline
    \texttt{time} & 92.4 & 95.8 & 99.1 & 94.5 \\
      \texttt{age} & 32.6 & 34.4 & 36.2 & 35.5 \\
      \hline
