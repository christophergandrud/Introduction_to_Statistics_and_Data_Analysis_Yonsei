...
\end{knitrout}
  ...
  {\large{So, \texttt{time} in our original sample with 100 observations had a sampleing mean of 94.9 and a standard error of 1.7.
\end{frame}
...
\frame{
  \frametitle{Um\ldots}
  {\Large{Um \ldots a sampleing mean of 94.9 and a standard error of 1.7? \\[1cm]
...
\frame{
  ...
  \begin{table}
    ...
    \hline\hline
    \texttt{time} & 91.6 & 94.9 & 98.2 & 94.5 \\
      \texttt{age} & 35.3 & 37.6 & 39.9 & 35.5 \\
      \hline
