...
\end{knitrout}
  ...
  {\large{So, \texttt{time} in our original sample with 100 observations had a sampleing mean of 93.1 and a standard error of 1.7.
\end{frame}
...
\frame{
  \frametitle{Um\ldots}
  {\Large{Um \ldots a sampleing mean of 93.1 and a standard error of 1.7? \\[1cm]
...
\frame{
  ...
  \begin{table}
    ...
    \hline\hline
    \texttt{time} & 89.7 & 93.1 & 96.4 & 94.5 \\
      \texttt{age} & 32.9 & 34.7 & 36.5 & 35.5 \\
      \hline
