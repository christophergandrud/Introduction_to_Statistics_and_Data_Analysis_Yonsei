...
@
  ...
  {\large{\texttt{Time} in our original sample with 100 observations had a sampleing mean of \Sexpr{round(mean(Run10Samp$time), digit = 1)} and a standard error of \Sexpr{round(std.error(Run10Samp$time), digit = 1)}.
\end{frame}
