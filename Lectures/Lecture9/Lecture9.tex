...
\begin{frame}[fragile]
  ...
  The mean finishing time in the sample is 93.2 minutes with a standard deviation of 14.8}}
\end{frame}
...
\begin{frame}[fragile]
  ...
  To find the p-value for the -0.1 use \texttt{pnorm}.
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
So, if the null hypothesis was true we would have a 0.5206 probability of observing a mean of at least -0.1 larger than the 2006 mean. \\[0.25cm]
