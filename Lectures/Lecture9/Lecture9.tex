...
\begin{frame}[fragile]
  ...
  The mean finishing time in the sample is 94.8 minutes with a standard deviation of 17.2}}
\end{frame}
...
\begin{frame}[fragile]
  ...
  To find the p-value for the 1.2 use \texttt{pnorm}.
\begin{knitrout}
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
...
So, if the null hypothesis was true we would have a 0.1112 probability of observing a mean of at least 1.2 larger than the 2006 mean. \\[0.25cm]
